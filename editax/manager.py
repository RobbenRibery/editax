...
class EditorManager:
    ...
    def __init__(
        ...
        default_random_prob:float,
        
        mutators_filename: str,
        ...
        self.default_random_prob = default_random_prob
        ...
        # mutators info
        self.init_mutators = init_mutators
        self.mutators_dir = mutators_dir
        self.mutators_filename = mutators_filename
        self.mutators_path = os.path.join(self.mutators_dir, self.mutators_filename)
